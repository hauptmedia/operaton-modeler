...
All notable changes to the [Operaton Modeler](https://github.com/operaton/operaton-modeler) are documented here. We use [semantic versioning](http://semver.org/) for releases.
